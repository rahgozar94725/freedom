...
نرم افزار را اجرا کنید. آیکون آن در کنار ساعت ویندوز نمایان میشود. با دبل کلیک روی آن پنجره زیر باز میشود. طبق توضیحات اطلاعات لازم را تکمیل کنید.
...
* در شماره یک اگر طبق آموزش پیشرفته باشید چند انتخاب دارید
  ...
  * کاستوم آیپی کلاودفلر
  * دامنه هایی که از CDN کلاودفلر استفاده میکنند و فیلتر نیستند مثل `discord.com`
