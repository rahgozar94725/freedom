...
- در شماره 3 پسوردی را که در مراحل نصب انتخاب کردید وارد کنید
- در شماره 4 از لیست باز شونده متودی را که در مرحله نصب انتخاب کرده بودید وارد کنید
- در شماره 5 از لیست بازشونده پلاگین `xray` را انتخاب کنید
- در شماره 6 روی `Configure` کلیک کنید.
- در شماره 7 با توجه به انتخابی که در مرحله نصب انجام داده اید یکی از حالت های زیر را انتخاب کنید.
  - اگر انتخابتان `server;mode=grpc;serviceName=grpc7070` بود، `grpc-tls` را انتخاب کنید.
  - اگر انتخابتان `server;path=/wss7070` بود، `websocket-tls` را انتخاب کنید.
- در شماره 8 از هر CDN که استفاده میکنید باید دامنه مستقیم آن CDN را وارد کنید. یعنی دامنه ای که پروکسی آن خاموش است.
- در شماره 9 با توجه به انتخابی که در مرحله نصب انجام داده اید، یکی از حالت های زیر را انتخاب کنید. اگر در مرحله نصب پورت `7070` را تغییر داده اید آن را جایگزین کنید.
  - اگر انتخابتان `server;mode=grpc;serviceName=grpc7070` بود، در قسمت `Service name` باید `grpc7070` را وارد کنید.
