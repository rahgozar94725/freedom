...
- در شماره 2 و 3 در صورتی که میخواهید با دامنه خود و SSL وارد پنل شوید، باید گواهی SSL خود را وارد کنید.
  ...
  - بعد از ذخیره تغییرات آدرس پنل به صورت `https://sub.test.com:54321/ay4l/xui/` خواهد شد. `sub.test.com` را با دامنه خود جایگزین کنید. (در صورت عدم دسترسی به پنل با دامنه کافی هست با دستور `shutdown -r now` سرور رو ریستارت کنید.)
